...
# $ENV{HOME}/remap_gff
use constant LOCATION => "/usr/local/wormbase/update_scripts";

# the ftp URL to grab updated genome assembly data, if available
use constant FTP      => "ftp://ftp.sanger.ac.uk/pub2/wormbase/Remap-between-versions/Mapping-data/";
