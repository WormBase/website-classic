...
=head1 SYNOPSIS
 ...
 Main method:       -none
 Sub methods:       nucleotide_match_elegans:waba_weak nucleotide_match_elegans:waba_strong 
                    nucleotide_match_elegans::waba_coding
 -------------------------------------------------------------------------------------
...
feature types into an aggregate type of "waba_alignment":
   ...
   nucleotide_match_elegans:waba_weak
   nucleotide_match_elegans:waba_strong
   nucleotide_match_elegans:waba_coding

=cut

package Bio::DB::GFF::Aggregator::waba_alignment_elegans;
...
sub method { 'waba_alignment_elegans' }
...
=head2 part_names
 ...
 Returns : the list "nucleotide_match_elegans:waba_weak", "nucleotide_match_elegans:waba_strong" and "nucleotide_match_elegans:waba_coding"
 Args    : none
 Status  : Public
