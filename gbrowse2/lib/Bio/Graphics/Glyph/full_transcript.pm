package Bio::Graphics::Glyph::full_transcript;
...
sub bgcolor {
  ...
  if ($feature->can('primary_tag') && $feature->primary_tag =~ /.*prime.*/i) {
...
sub draw_component {
  ...
  #  return if $feature->can('primary_tag') && $feature->primary_tag eq 'coding_exon';
...
Bio::Graphics::Glyph::full_transcript - The "full_transcript" glyph
